            ...
            children: [
                messages.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("div", {
                    ...
                    columnNumber: 11
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("div", {
                            className: `max-w-[80%] p-4 rounded-lg ${message.role === 'user' ? 'bg-blue-500 text-white' : 'bg-gray-100 dark:bg-gray-800 text-gray-900 dark:text-gray-200'}`,
                            children: message.role === 'assistant' ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$externals$5d2f$react$2d$markdown__$5b$external$5d$__$28$react$2d$markdown$2c$__esm_import$29$__["default"], {
...
function AISearch() {
    ...
    const convertMessagesToChat = (messages)=>{
        const chatMessages = [];
        ...
        try {
            ...
            const response = await fetch('http://localhost:8000/api/ai-search/stream-chat', {
                ...
                body: JSON.stringify({
                    ...
                    messages: convertMessagesToChat(updatedMessages)
                })
            });
            ...
            if (docIdBuffer) {
                doc_ids = docIdBuffer.split(',').map((id)=>parseInt(id.trim()));
            }
            const token = localStorage.getItem('token');
            await fetch('http://localhost:8000/api/ai-search/save-message', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${token}`
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__5ef71e._.js.map